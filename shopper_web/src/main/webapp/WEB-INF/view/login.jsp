...
<head>
    ...
    <script type="text/javascript" src="${path}/js/crypto-md5.js"></script>
...
<script>
    $('#login-button').click(function (event) {
        ...
        var json = sendRequestJson("POST",false,"${path}/login.do",{"username": username, "password": password},"${path}/loginIndex.do");
        if (json.code == "0000") {
            $.message({
                message: "登录成功",
                time: '2000',
            ...
            $(window).attr('location','${path}/mainIndex.do');
        }else {
            $.message({
                message: json.msg,
                time: '2000',
